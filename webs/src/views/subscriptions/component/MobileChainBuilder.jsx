...
export default function MobileChainBuilder({
    ...
    return (
        <Box>
                ...
                >
                    <CardContent sx={{ py: 1.5, px: 2, '&:last-child': { pb: 1.5 } }}>
                        <Stack direction="row" alignItems="center" spacing={1}>
                            <PlayArrowIcon />
                            <Typography variant="subtitle2" fontWeight={600}>入口</Typography>
                        </Stack>
                    </CardContent>
                </Card>
                    ...
                    <CardContent sx={{ py: 1.5, px: 2, '&:last-child': { pb: 1.5 } }}>
                        <Stack direction="row" alignItems="center" justifyContent="space-between">
                            <Stack direction="row" alignItems="center" spacing={1}>
                                <StopIcon />
                                <Box>
                                    <Typography variant="caption" sx={{ opacity: 0.9 }}>目标节点</Typography>
            ...
            >
                <DialogTitle>
                    {editingProxyConfig?.isNew ? '添加入口代理' : '编辑入口代理'}
                </DialogTitle>
                <DialogContent>
                ...
                <DialogActions>
                    ...
                    <Button variant="contained" onClick={handleSaveProxy}>确定</Button>
                </DialogActions>
            </Dialog>
            ...
            >
                ...
                <DialogActions>
                    ...
                    <Button variant="contained" onClick={handleSaveTarget}>确定</Button>
                </DialogActions>
            </Dialog>
        </Box>
    );
