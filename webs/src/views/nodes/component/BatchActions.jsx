  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center" }}>
        <Checkbox checked={isAllSelected} indeterminate={isIndeterminate} onChange={(e) => onSelectAll(e)} size="small"
                  sx={{ p: 0.5 }} />
        <Typography
          variant="body2"
          sx={{
      ...
      {selectedCount > 0 && (
        <>
          ...
          {/* 清除选择按钮 */}
          <Button size="small" color="inherit" startIcon={<ClearIcon />} onClick={onClearSelection}
