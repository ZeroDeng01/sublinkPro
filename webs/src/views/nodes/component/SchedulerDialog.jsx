            ...
            <TableBody>
              {schedulers.map((scheduler) => (
                <TableRow key={scheduler.ID}>
                  ...
                  <TableCell
                    sx={{ maxWidth: 200, overflow: "hidden", textOverflow: "ellipsis" }}>{scheduler.URL}</TableCell>
                  <TableCell>
                  ...
                  <TableCell>
                    <Chip label={scheduler.Enabled ? "启用" : "禁用"} color={scheduler.Enabled ? "success" : "default"}
                          size="small" />
                  </TableCell>
